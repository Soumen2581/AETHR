...
if(MSVC)
    set(AETHR_STRICT_WARNINGS
        /W4
        /permissive-)

    set(AETHR_WARNINGS_AS_ERRORS_FLAG /WX)
else()
    set(AETHR_STRICT_WARNINGS
        -Wall
        -Wextra
    ...
    set(AETHR_WARNINGS_AS_ERRORS_FLAG -Werror)
endif()

# Applies the strict warning set (and -Werror when requested) to the given
# source files only.
function(aethr_apply_strict_warnings)
    set(flags ${AETHR_STRICT_WARNINGS})

    if(AETHR_WARNINGS_AS_ERRORS)
        list(APPEND flags ${AETHR_WARNINGS_AS_ERRORS_FLAG})
    endif()
...
function(aethr_relax_source_warnings flag)
    foreach(source_file IN LISTS ARGN)
        get_source_file_property(existing "${source_file}" COMPILE_OPTIONS)
